...
/**
 * AST helpers shared by the rules below. Ported from pingdotgg/t3code's
 * oxlint-plugin-t3code/utils.ts (a production effect@4.0.0-beta.101
 * monorepo) — generic, no t3code-specific assumptions.
 */
