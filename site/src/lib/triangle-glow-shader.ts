/**
 * VENDORED VERBATIM from the app — src/components/triangle-glow-shader.ts.
 * Do not edit here. The site shows the real effect, not an impression of it, so
 * this file is a copy rather than a re-implementation; if the app's shader
 * changes, re-copy it.
 *
