...
//! framework's logo (Vercel's icon set, bundled from assets/icons) badged
...
const ROOT_FOLDER_ICON: &[u8] = include_bytes!("../../assets/icons/mac/folder-vercel.png");

/// Pre-composited macOS folder + framework badge (assets/icons/mac/).
fn framework_folder_png(framework: &str) -> &'static [u8] {
    match framework {
        "nextjs" => include_bytes!("../../assets/icons/mac/folder-nextjs.png"),
        "nuxt" => include_bytes!("../../assets/icons/mac/folder-nuxt.png"),
        "astro" => include_bytes!("../../assets/icons/mac/folder-astro.png"),
        "remix" => include_bytes!("../../assets/icons/mac/folder-remix.png"),
        "svelte" => include_bytes!("../../assets/icons/mac/folder-svelte.png"),
        "vue" => include_bytes!("../../assets/icons/mac/folder-vue.png"),
        "vite" => include_bytes!("../../assets/icons/mac/folder-vite.png"),
        "react" => include_bytes!("../../assets/icons/mac/folder-react.png"),
        "hono" => include_bytes!("../../assets/icons/mac/folder-hono.png"),
        "express" => include_bytes!("../../assets/icons/mac/folder-express.png"),
        _ => include_bytes!("../../assets/icons/mac/folder-other.png"),
    }
}
